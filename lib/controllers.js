var async  = require('async')
  ...
  , invokeFilters = function (filters, ctx, callback) {
      async.forEachSeries(
          filters.map(function (f) { return f.bind(ctx) })
        , function (filter, callback) {
            filter(ctx.req, ctx.res, callback)
          }
        , callback
      )
    }
  ...
  , createInvoker = function (viewHandler, filters, ctx, handler) {
      ...
      return function () {
        ...
        invokeFilters(filters, this, function (err) {
